...
namespace shark {
    namespace protocols {
        namespace matmul {
            ...
            void call_share_secret_full(u64 a, u64 b, u64 c, const shark::span<u128> &X_share, const shark::span<u128> &X_tag, const shark::span<u128> &Y_share, const shark::span<u128> &Y_tag, shark::span<u128> &Z_share, shark::span<u128> &Z_tag);
            ...
            AuthShareFull call_share_secret_full(u64 a, u64 b, u64 c, const shark::span<u128> &X_share, const shark::span<u128> &X_tag, const shark::span<u128> &Y_share, const shark::span<u128> &Y_tag);
