...
namespace shark
{
    namespace crypto
    {
        ...
        std::pair<DCFRingKey, DCFRingKey> dcfring_gen(int bin, const u128 alpha, const bool greaterThan = false);
        std::tuple<u128, u128> dcfring_eval(int party, const DCFRingKey &key, const u128 &x, const bool greaterThan = false);
    }
}
