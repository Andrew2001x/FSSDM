...
namespace shark
{
    namespace crypto
    {
        ...
        std::pair<DCFBitKey, DCFBitKey> dcfbit_gen(int bin, const u128 alpha, const bool greaterThan = false);
        std::tuple<u8, u64> dcfbit_eval(const DCFBitKey &key, const u128 &x, const bool greaterThan = false);
    }
}
