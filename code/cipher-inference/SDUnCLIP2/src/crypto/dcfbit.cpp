...
namespace shark
{
    namespace crypto
    {
        ...
        std::pair<DCFBitKey, DCFBitKey> dcfbit_gen(int bin, const u128 alpha, const bool greaterThan)
        {
            u8 payload_bit = 1;
        ...
        std::tuple<block, u8, u64, u64> traversePathDCF(const DCFBitKey &key, u128 x, const bool geq)
        {
        ...
        std::tuple<u8, u64> dcfbit_eval(const DCFBitKey &key, const u128 &x, const bool greaterThan)
        {
